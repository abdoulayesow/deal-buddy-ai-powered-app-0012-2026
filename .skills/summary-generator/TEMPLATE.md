...
### [Category 2 - e.g., "WhatsApp Integration"]
...
| File | Purpose |
|------|---------|
| `path/to/critical/file.ts` | [Why this file is important] |
...
- path/to/main/file.ts (primary changes)
...
1. **Feature Name**: Use kebab-case for the filename (e.g., `webhook-implementation`)
