...
Review the conversation for token efficiency opportunities using [guidelines/token-optimization.md](guidelines/token-optimization.md).
...
Review tool calls for accuracy and error patterns using [guidelines/command-accuracy.md](guidelines/command-accuracy.md).
...
2. Create `docs/summaries/2026-02-24_webhook-implementation.md`
